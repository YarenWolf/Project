...
//import XExtension
//class QRCodeScanViewController: UIViewController,AVCaptureMetadataOutputObjectsDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate,UITextFieldDelegate{
...
//        let maskViewSize = CGSize(width: APPW/2, height: APPW/2)///正方形，下面会露出来，还要添加补充遮罩
//        maskView.frame = CGRect(x: 0, y: 64, width: maskViewSize.width, height: maskViewSize.height)
//        self.view.addSubview(maskView)
//        ///补充遮罩
//        let mask = UIView(frame: CGRect(x: 0, y: maskView.frame.origin.y + maskView.frame.size.height, width: APPW, height: APPH - (maskView.frame.origin.y + maskView.frame.size.height)))
//        mask.backgroundColor = UIColor(red: CGFloat(0), green: CGFloat(0), blue: CGFloat(0), alpha: CGFloat(0.7))
//        self.view.addSubview(mask)
//    }
//    func setupTipTitleView() {
//        ///操作提示
//        let tipLabel = UILabel(frame: CGRect(x: 0, y: maskView.frame.maxY + 30, width: self.view.frame.size.width, height: 100))
...
//    func setupBottomBar() {
//        ///1.下边栏
//        let bottomBar = UIView(frame: CGRect(x: 0, y: APPH * 0.9, width: APPW, height: APPH * 0.1))
...
//        myCodeBtn.frame = CGRect(x: 0, y: 0, width: APPW * 0.1 * (35 / 49), height: APPH * 0.1)
//        myCodeBtn.center=CGPoint(x: APPW / 2, y: APPH * 0.1 / 2);
...
//                
//                ///展示在界面上
//                let imageBtn = UIButton(frame: CGRect(x: 0, y: 64, width: APPW, height: APPH - 64))
...
//                imageBtn.backgroundColor = .yellow
...
//        
//        let scanWindowH = maskView.frame.size.width - kMargin * 2 ///kMargin为黑色边框的一半，
...
//        scanNetImageView.frame.origin.y = (-1 * scanNetImageView.frame.size.height)
...
//            [unowned self] in
//            self.scanNetImageView.transform = self.scanNetImageView.transform.translatedBy(x: 0, y: self.scanWindow.frame.size.height)
//            }, completion: nil)
//        
//        ///way 2、coreAnimation
//        
...
//        
//        //设置扫码支持的类型
//        output.metadataObjectTypes = [AVMetadataObjectTypeDataMatrixCode,AVMetadataObjectTypeAztecCode,AVMetadataObjectTypeQRCode,AVMetadataObjectTypePDF417Code,AVMetadataObjectTypeEAN13Code,AVMetadataObjectTypeEAN8Code,AVMetadataObjectTypeCode128Code]
